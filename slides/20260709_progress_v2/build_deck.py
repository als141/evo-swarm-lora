...
def sl_apx_numbers():
    ...
    rows = [
        ...
        ("LoRAチーム（本命）", "71.6", "86.7", "43.1", "ベースと互角・数学はSC@9と互角"),
    ]
    x0, y0 = 0.95, 2.15
    ws = [3.5, 1.9, 1.7, 1.7, 3.6]
    rh = 0.66
    ...
    text(s, 0.95, 5.35, 11.4, 1.3, [
        ("・数学（MATH-500）では、LoRAチームと多数決9回は統計的に互角（差 −0.7点, 有意差なし）。\n", 12.5, INK, FONT_REG, {}),
        ("・総合（6,000問）では、LoRAチームは多数決9回に −3.0点（有意）。ベース単体とは互角（+0.3点）。\n", 12.5, INK, FONT_REG, {}),
        ("・多数決9回とベース／LoRAチームは6シード、素の議論などの補助条件は3シードで測定。", 12, SUB, FONT_REG, {}),
    ], line_spacing=1.3)
    apx_foot(s, 1)
